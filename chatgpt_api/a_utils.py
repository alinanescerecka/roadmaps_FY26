...
step_2_system_message = {'role':'developer', 'content': step_2_system_message_content}    
...
step_4_system_message = {'role':'developer', 'content': step_4_system_message_content}    
...
step_6_system_message = {'role':'developer', 'content': step_6_system_message_content}    


def get_completion_from_messages(messages, model="gpt-4.1-mini", temperature=0, max_output_tokens=500):
